            ...
            <div className='card-content'>
                ...
                <div className='wrapper'>
                    <div className='progress-bar'>
                        <span
                            className='progress-bar-fill'
                            style={{
                                width: pokemon.stats.special_attack + '%',
                                backgroundColor: '#bed6af',
                            }}
                        ></span>
                    </div>
                </div>
                ...
                <div className='wrapper'>
                    <div className='progress-bar'>
                        <span
                            className='progress-bar-fill'
                            style={{
                                width: pokemon.stats.special_defense + '%',
                                backgroundColor: '#54a666',
                            }}
                        ></span>
                    </div>
                </div>
                ...
                <div className='wrapper'>
                    <div className='progress-bar'>
                        <span
                            className='progress-bar-fill'
                            style={{ width: pokemon.stats.speed + '%', backgroundColor: '#2c9474' }}
                        ></span>
                    </div>
                </div>
            </div>
